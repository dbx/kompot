...
public final class MethodRequestFrame<Req> {
    ...
    private MethodRequestFrame(UUID identifier, MethodDescriptor<Req, ?> methodMarker, Req methodData, String sourceIdentifier) {
    ...
    public static <Req> MethodRequestFrame<Req> build(UUID identifier, ProducerIdentity sender, MethodDescriptor<Req, ?> marker, Req request) {
        return new MethodRequestFrame(identifier, marker, request, sender.getIdentifier());
    }

    @SuppressWarnings("unchecked")
    public static <Req> MethodRequestFrame<Req> build(ProducerIdentity sender, MethodDescriptor<Req, ?> marker, Req request) {
        return new MethodRequestFrame(UUID.randomUUID(), marker, request, sender.getIdentifier());
    }
